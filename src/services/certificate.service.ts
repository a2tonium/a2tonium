...
export async function fetchMockCertificate(): Promise<CertificateCompletionInterface> {
    ...
    return {
        ...
        attributes: [
            { trait_type: "Completion Status", value: "Oh Yeah" },
            { trait_type: "Completion Date", value: "2025-04-08" },
            { trait_type: "Instructor", value: "Dr. Akylzhan Akatakatukasay" },
            { trait_type: "Student_IIN", value: "050204814823" },
            { trait_type: "email", value: "animemylife@gmail.com" },
            { trait_type: "Average Grade", value: "100%" },
