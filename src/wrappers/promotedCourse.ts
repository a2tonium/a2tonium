...
function dictValueParserCoursePromotionFactory$Data(): DictionaryValue<CoursePromotionFactory$Data> {
 ...
 type PromotedCourse_init_args = {
    $$type: 'PromotedCourse_init_args';
    collection_address: Address;
    item_index: bigint;
}

function initPromotedCourse_init_args(src: PromotedCourse_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.collection_address);
        b_0.storeInt(src.item_index, 257);
...
async function PromotedCourse_init(collection_address: Address, item_index: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initPromotedCourse_init_args({ $$type: 'PromotedCourse_init_args', collection_address, item_index })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const PromotedCourse_errors = {
...
export const PromotedCourse_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const PromotedCourse_types: ABIType[] = [
...
const PromotedCourse_getters: ABIGetter[] = [
    {"name":"get_nft_data","methodId":102351,"arguments":[],"returnType":{"kind":"simple","type":"GetNftData","optional":false}},
]

export const PromotedCourse_getterMapping: { [key: string]: string } = {
    'get_nft_data': 'getGetNftData',
}

const PromotedCourse_receivers: ABIReceiver[] = [
...
export class PromotedCourse implements Contract {
    
    public static readonly storageReserve = 20000000n;
    public static readonly errors = PromotedCourse_errors_backward;
    public static readonly opcodes = PromotedCourse_opcodes;
    
    static async init(collection_address: Address, item_index: bigint) {
        return await PromotedCourse_init(collection_address, item_index);
    }
    
    static async fromInit(collection_address: Address, item_index: bigint) {
        const __gen_init = await PromotedCourse_init(collection_address, item_index);
        const address = contractAddress(0, __gen_init);
        return new PromotedCourse(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new PromotedCourse(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  PromotedCourse_types,
        getters: PromotedCourse_getters,
        receivers: PromotedCourse_receivers,
        errors: PromotedCourse_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: GetStaticData | Transfer) {
