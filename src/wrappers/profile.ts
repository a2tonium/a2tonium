...
function dictValueParserProfileFactory$Data(): DictionaryValue<ProfileFactory$Data> {
 ...
 type Profile_init_args = {
    $$type: 'Profile_init_args';
    collection_address: Address;
    item_index: bigint;
}

function initProfile_init_args(src: Profile_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.collection_address);
        b_0.storeInt(src.item_index, 257);
...
async function Profile_init(collection_address: Address, item_index: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initProfile_init_args({ $$type: 'Profile_init_args', collection_address, item_index })(builder);
...
export const Profile_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
export class Profile implements Contract {
    
    public static readonly storageReserve = 20000000n;
    public static readonly errors = Profile_errors_backward;
    public static readonly opcodes = Profile_opcodes;
    
    static async init(collection_address: Address, item_index: bigint) {
        return await Profile_init(collection_address, item_index);
    }
    
    static async fromInit(collection_address: Address, item_index: bigint) {
        const __gen_init = await Profile_init(collection_address, item_index);
        const address = contractAddress(0, __gen_init);
        return new Profile(address, __gen_init);
    }
    ...
    readonly abi: ContractABI = {
        types:  Profile_types,
        getters: Profile_getters,
        receivers: Profile_receivers,
