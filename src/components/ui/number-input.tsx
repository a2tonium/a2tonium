...
function NumberInputField({
  ...
  return (
    <NumberInputPrimitive.Input
      ...
      className={cn(
        "focus-visible:outline-blue-500/50 h-full w-full border-x px-3 py-1 text-center text-base tabular-nums transition-all ease-out data-disabled:cursor-not-allowed md:text-sm",
        className
      )}
      {...props}
    />
